                    ...
                    <tbody>
                        ...
                        <tr>
                                ...
                                <td align="center">
                                    ...
                                    <a href="" id-K="<?php echo $row['id'] ?>" class="btn btn-danger btn-xs delete"><i class="fa fa-remove"></i></a>
                                </td>
                        </tr>
                        <?php
                            $no++;
    ...
    $('.delete').on('click', function(e){
        if(!e.isDefaultPrevented()){
            ...
            function(isConfirm) {
                if(isConfirm) {
                    $.ajax({
                        url: "<?php echo BASE_URL . '?p=delete&m=pelanggan' ?>",
                        type: "POST",
                        method: "POST",
                        data: {id_pelanggan: idk},
